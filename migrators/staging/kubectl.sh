...
main() {
  ...
  waitress "${kubernetes_repo_root_dir}" "staging/src/k8s.io/cli-runtime" "${destination_path}"
  ...
  waitress "${kubernetes_repo_root_dir}" "staging/src/k8s.io/component-helpers" "${destination_path}"
  waitress "${kubernetes_repo_root_dir}" "staging/src/k8s.io/metrics" "${destination_path}"
