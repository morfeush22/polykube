...
main() {
  ...
  waitress "${kubernetes_repo_root_dir}" "vendor/k8s.io/cloud-provider/go.mod" "${destination_path}"
  twin "${destination_path}" "vendor/k8s.io/cloud-provider" "staging/src/k8s.io/cloud-provider"

  waitress "${kubernetes_repo_root_dir}" "vendor/k8s.io/csi-translation-lib/go.mod" "${destination_path}"
  twin "${destination_path}" "vendor/k8s.io/csi-translation-lib" "staging/src/k8s.io/csi-translation-lib"

  waitress "${kubernetes_repo_root_dir}" "vendor/k8s.io/controller-manager/go.mod" "${destination_path}"
